...
| HL-2026-06-02-001 | 2026-06-02 | 豆包单击 fn 录音状态机调整 | `docs/09-PLANNING/TASKS/TASK-2026-06-02-001-single-fn-doubao/task_plan.md` | `n/a: simple self-check` | `walkthrough skipped-with-reason: no-runtime` | `node JSON parse`; `live karabiner markers absent`; `micReset` | `用户实际按键确认豆包录音开始/停止` | `checked-none: 一次性本机输入法触发语义调整，无新增通用流程` | closed-with-residual |
